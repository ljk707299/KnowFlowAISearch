...
def get_current_weather(province: str, city: str) -> str:
    ...
    :param province: 省份名称
    :param city: 城市名称
    :return: 天气预报的 JSON 字符串（若失败则返回提示信息）
    """
    # 城市名称与天气 API 城市代码的映射表
    cityMap = {
    ...
    if response.status_code == 200:
        ...
        # 捕获异常并返回错误信息
        json_string = f"请求天气信息失败: {e}"
    return json_string


if __name__ == "__main__":
    # 以 stdio 方式启动 MCP 服务，适用于子进程管道通信
    mcp.run(
        transport="stdio", 
     )
...
# { "jsonrpc": "2.0", "id": 2, "method": "prompts/get", "params": { "name": "ask_review", "arguments": { "code_snippet": "def hello():\n    print('world')" } } }